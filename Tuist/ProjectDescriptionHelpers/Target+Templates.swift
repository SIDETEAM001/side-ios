...
public extension Target {
    ...
    static func flow(implements module: ModulePath.Flow, factory: TargetFactory) -> Self {
        var newFactory = factory
        newFactory.name = ModulePath.Flow.name + module.rawValue
        
        return make(factory: newFactory)
    }
    
    static func flow(interface module: ModulePath.Flow, factory: TargetFactory) -> Self {
        var newFactory = factory
        newFactory.name = ModulePath.Flow.name + module.rawValue + "Interface"
        newFactory.sources = .interface
