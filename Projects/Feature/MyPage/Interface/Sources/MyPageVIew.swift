...
public class MyPageVIew: UIView {
    ...
    let firstRowLabel = CellRowView(title: "내 모임")
    let secondRowLabel = CellRowView(title: "찜한 모임")
    let thirdRowLabel = CellRowView(title: "내 플레이스")
    let thirdSectionLabel = UILabel()
    let fourthRowLabel = CellRowView(title: "내가 쓴 글")
    let fifthRowLabel = CellRowView(title: "댓글 단 글")
    let sixthRowLabel = CellRowView(title: "좋아요 한 글")
    ...
    func addSubviews() {
        ...
        [modifyButton, mainImageView, profileName, postionLabel, emailLabel, hobbyHorizontalStackView].forEach {
    ...
    func setupConstraints() {
        ...
        postionLabel.snp.makeConstraints {
        ...
        emailLabel.snp.makeConstraints {
            $0.top.equalTo(postionLabel.snp.bottom).offset(2)
            $0.leading.equalTo(mainImageView.snp.trailing).offset(24)
            $0.trailing.equalToSuperview().offset(-20)
        }
