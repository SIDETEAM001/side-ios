...
public class AlbumViewController: UIViewController, ReactorKit.View{
    ...
    public init(with reator: AlbumReactor){
...
extension AlbumViewController{
    public func bind(reactor: AlbumReactor) {
        bindAction(reactor: reactor)
        bindState(reactor: reactor)
    }
    
    private func bindAction(reactor: AlbumReactor){
        backButton.rx.tap
    ...
    private func bindState(reactor: AlbumReactor){
